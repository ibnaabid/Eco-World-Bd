    ...
    >
      ...
      <div className="relative text-center max-w-lg z-10">
        ...
        <motion.p
          ...
          className="text-[14.5px] mb-9 max-w-sm mx-auto"
        ...
        >
          <motion.a
            ...
            whileHover={{ y: -3 }}
            whileTap={{ scale: 0.96 }}
            className="flex items-center gap-2 px-7 py-3.5 rounded-full text-[14px] font-semibold transition-all"
          ...
          <motion.button
            ...
            whileHover={{ y: -3 }}
            whileTap={{ scale: 0.96 }}
            className="flex items-center gap-2 px-7 py-3.5 rounded-full text-[14px] font-semibold border transition-all"
            style={{ 
              borderColor: "rgba(246,242,233,0.35)", 
              color: colors.cream 
            }}
          >
